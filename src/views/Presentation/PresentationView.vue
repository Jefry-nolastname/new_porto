...
//images
import vueMkHeader from "@/assets/img/promobanner.jpeg";
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-7 text-center mx-auto position-relative">
            ...
            <p class="lead text-white px-5 mt-3" :style="{ fontWeight: '380' }">
              I made this site as a medium to show case my
              <b
                >past achievements </b
              >, <b>skill sets</b>, <b>working experiences</b>, or some
                <b>basic informations</b>
              about me. This website is powered by Vuejs and Vue Material Kit.
            </p>
          </div>
        </div>
      </div>
